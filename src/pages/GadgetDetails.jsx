  ...
  return (
    <div>
      ...
      <div className="relative -top-28 left-40 ">
        <div className="card card-side bg-base-100 shadow-xl w-3/4 p-6">
          <figure className="w-80 h-96 rounded-xl">
            <img
          ...
          <div className="card-body py-0">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="badge bg-[#09080F0D]">{rating}</div>
            </div>
            ...
            <div className="flex items-center gap-8">
              ...
              >
                Add To Carts<IoCartOutline></IoCartOutline>
              </button>
              <button
                disabled={isFav}
                className="btn btn-ghost btn-circle border-2 border-[#0B0B0B1A]"
              >
                <div
